...
const JobsManagementView: React.FC = () => {
    ...
    const { viewJobData, appliedApplicants, viewJobIsLoading } =
        useJobViewHook(id);
                ...
                <>
                    <div>
                        <div className="grid grid-cols gap-y-2">
                            ...
                            <Breadcrumbs className="text-blue-500">
                                {items}
                            </Breadcrumbs>
                        </div>
