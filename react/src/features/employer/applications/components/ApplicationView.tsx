  ...
  return (
    <>
      <div className="grid grid-cols gap-y-2">
        <h1 className="font-bold text-textBlack text-xl">Application</h1>
              ...
              <Card.Section>
                <Tabs defaultValue="applicantProfile">
                  <Tabs.List>
                    ...
                    <Tabs.Tab value="hiringProgress" color="blue">
                      Hiring Progress
                    </Tabs.Tab>
                  </Tabs.List>
                  <Tabs.Panel px="md" value="applicantProfile" pt="xs">
                    <ApplicantProfile applicantProfileData={candidateData} />
                  </Tabs.Panel>
                  <Tabs.Panel px="md" value="hiringProgress" pt="xs">
                    <HiringProgressTab hiringProgressData={candidateData} />
                  </Tabs.Panel>
                </Tabs>
              </Card.Section>
            </Card>
